...
const int BALL_SPAWN_OFFSET = 25;

const int BALL_SPAWN_BOUNDS_LEFT = BALL_SPAWN_OFFSET;
const int BALL_SPAWN_BOUNDS_RIGHT = SCREEN_WIDTH - BALL_SPAWN_OFFSET;
const int BALL_SPAWN_BOUNDS_TOP = BRICK_AREA_Y_END + 50 + BALL_SPAWN_OFFSET;
const int BALL_SPAWN_BOUNDS_BOTTOM = BRICK_AREA_Y_END + 200 - BALL_SPAWN_OFFSET;
